...
if results:
    ...
    display_df["LinkedIn"] = display_df["LinkedIn"]
    ...
    st.dataframe(
        ...
        column_config={
            ...
            "SIC": st.column_config.TextColumn("SIC", width="small"),
            "Incorporated": st.column_config.TextColumn("Incorporated", width="small"),
            "Age": st.column_config.TextColumn("Age", width="small"),
            "Total Assets": st.column_config.TextColumn("Total Assets", width="small"),
            "Net Assets": st.column_config.TextColumn("Net Assets", width="small"),
            "Fixed Assets": st.column_config.TextColumn("Fixed Assets", width="small"),
            "Current Assets": st.column_config.TextColumn("Current Assets", width="small"),
            "Employees": st.column_config.TextColumn("Employees", width="small"),
            "Accounts Date": st.column_config.TextColumn("Accounts Date", width="small"),
            "Dir. Appointed": st.column_config.TextColumn("Dir. Appointed", width="small"),
            "CH company": st.column_config.LinkColumn("CH Company", width="small", display_text="Open"),
            "Officers": st.column_config.LinkColumn("Officers", width="small", display_text="Officers"),
            "LinkedIn": st.column_config.LinkColumn("LinkedIn", width="small", display_text="Search"),
        }
    )
    ...
    with col_a:
        ...
        try:
            ...
            ws = wb.active
            ws.title = "Prospects"
            # Build headers - replace CH Link/LinkedIn with readable names
