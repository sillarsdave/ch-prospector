...
def fetch_financials(company_number, api_key):
    ...
    try:
        ...
        result["net_assets"]     = fv(get_val(soup,["NetAssetsLiabilities","NetAssetsLiabilitiesIncludingPensionAssetLiability","NetAssets","ShareholdersEquity","Equity","MembersOtherInterests","TotalMembersInterests","MembersCapital"]))
